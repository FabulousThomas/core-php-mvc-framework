...
<div class="container mt-3">
      <div class="jumbotron jumbotron-fluid text-center">
            ...
            <p class="text-center m-0">A simple open source PHP MVC framework designed to help you build web applications quickly and efficiently.</p>
            <p class="text-center">Feel free to explore the code and contribute to the project!</p>
